...
public class Experiment_SPEA2_MqAp {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
        ...
        for (String problemname : softwares) {
            ...
            for (int runs = 0; runs < runsNumber; runs++) {
                ...
                resultFront.printObjectivesToFile("resultado/spea2/" + problem.getName() + "/FUN_spea2" + "-" + problem.getName() + "-" + runs + ".NaoDominadas");
                resultFront.printVariablesToFile("resultado/spea2/" + problem.getName() + "/VAR_spea2" + "-" + problem.getName() + "-" + runs + ".NaoDominadas");
            ...
            todasRuns.printObjectivesToFile("resultado/spea2/" + problem.getName() + "/All_FUN_spea2" + "-" + problem.getName());
            todasRuns.printVariablesToFile("resultado/spea2/" + problem.getName() + "/All_VAR_spea2" + "-" + problem.getName());
